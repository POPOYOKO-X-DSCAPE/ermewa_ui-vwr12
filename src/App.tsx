...
import { DocumentViewer } from "@packages/ui";
import { fetchAndProcessDocument } from "./infrastructure/helpers/fetch-and-process-document";
import services from "./infrastructure/services";

function App() {
  const { appProfile, loading: appLoading, document, error } = useAppContext();

  const actions = useFooterActions(document?.url || null, document?.code || "");
